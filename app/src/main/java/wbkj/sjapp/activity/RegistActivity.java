...
public class RegistActivity extends BaseActivity {
    ...
    private String phone, pwd, rpwd, code;
    ...
    private void initView() {
        ...
        etCode = (EditText) findViewById(R.id.reg_et_code);
        btnSend = (Button) findViewById(R.id.reg_btn_send);
        btnOk = (Button) findViewById(R.id.reg_btn_ok);
        etPwd = (EditText) findViewById(R.id.reg_et_pwd);
        etRpwd = (EditText) findViewById(R.id.reg_et_rpwd);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (StringUtils.isNotBlank(phone)) {
                    createLoadingDialog(RegistActivity.this, "发送中...").show();
    ...
    private void regMethod() {
        ...
        OkHttpClientManager.postAsyn(HttpUtil.regUrl, params, new OkHttpClientManager.ResultCallback<JsonElement>() {
            ...
            public void onError(Request request, Exception e) {
                ...
                Toast.makeText(RegistActivity.this, "网络连接失败,请重试", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onResponse(JsonElement response) {
                ...
                if (json.result == 1) {
                    ...
                    Toast.makeText(RegistActivity.this, json.msg, Toast.LENGTH_SHORT).show();
                }
            }
        }, null);
    }
