...
import wbkj.sjapp.utils.PayResult;
import wbkj.sjapp.utils.SignUtils;
...
public class AliPay {
    ...
    public AliPay(BaseActivity baseActivity, String orderNum) {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        Toast.makeText(baseActivity, "支付成功",
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            ...
                            Toast.makeText(baseActivity, "支付失败",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                    break;
     ...
     *
     */
    public void pay(String title, String content, String price) {
    ...
    public String getOrderInfo(String subject, String body, String price) {
        ...
        // 服务器异步通知页面路径
        orderInfo += "&notify_url=" + "\"" + HttpUtil.URL + "shangjie/Notifyurl.do"
                + "\"";
    ...
    public void notifyShoping(){
        ...
        OkHttpClientManager.postAsyn(HttpUtil.smsUrl, params, new OkHttpClientManager.ResultCallback<JsonElement>() {
            ...
            public void onResponse(JsonElement response) {
                Toast.makeText(baseActivity, "短信已发出", Toast.LENGTH_SHORT).show();
            }
        }, null);
    }
